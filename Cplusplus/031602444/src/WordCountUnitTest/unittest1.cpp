...
namespace CharCountTest//统计字符
{
	...
	public:
		...
		{
			char f[] = "D://软件工程//WCTEST//CharCountTest.txt";
...
namespace LineCountTest1//统计行数
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//LineCountTest1.txt";
...
namespace WordCountTest1//统计单词
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//WordCountTest1.txt";
...
namespace WordCountTest2//大小写单词
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//WordCountTest2.txt";
			int words = CountWords(f);
...
namespace SortCountTest1//按字典序输出
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//SortCountTest1.txt";
			vector<pair<string, int>> v;
			CountAndSort(f, v);
			vector<pair<string, int>>::iterator vec = v.begin();
...
namespace SortCountTest2//最多输出十个
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//SortCountTest2.txt";
			vector<pair<string, int>> v;
			CountAndSort(f, v);
...
namespace SortCountTest3//按词频输出
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//SortCountTest3.txt";
			vector<pair<string, int>> v;
			CountAndSort(f, v);
			vector<pair<string, int>>::iterator vec = v.begin();
...
namespace SortCountTest4//综合排序
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//SortCountTest4.txt";
			vector<pair<string, int>> v;
			CountAndSort(f, v);
			vector<pair<string, int>>::iterator vec = v.begin();
...
namespace EmptyFile//空文件
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//EmptyFile.txt";
			int chars = CountCharacters(f);
			int lines = CountLines(f);
			int words = CountWords(f);
...
namespace LineCountTest2
{
	...
	public:
		...
		TEST_METHOD(TestMethod1)
		{
			char f[] = "D://软件工程//WCTEST//LineCountTest2.txt";
			int lines = CountLines(f);
